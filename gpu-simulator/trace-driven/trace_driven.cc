...
void trace_simt_core_cluster::create_shader_core_ctx() {
  ...
  for (unsigned i = 0; i < m_config->n_simt_cores_per_cluster; i++) {
    ...
    m_core[i] = new trace_shader_core_ctx(m_gpu, this, sid, m_cluster_id,m_config, m_mem_config, m_stats);
...
void trace_shader_core_ctx::issue_warp_push_in_replay(register_set &warp, const warp_inst_t *pI,
                  const active_mask_t &active_mask, unsigned warp_id,
                  unsigned sch_id, int replay_buffer_idx, int pc, int sid, int MEM_ON) {

  shader_core_ctx::issue_warp_push_in_replay(warp, pI, active_mask, warp_id,
                  sch_id, replay_buffer_idx, pc, sid, MEM_ON);
...
void trace_shader_core_ctx::issue_warp_push_in_replay_mem(register_set &warp, const warp_inst_t *pI,
  ...
  shader_core_ctx::issue_warp_push_in_replay_mem(warp, pI, active_mask, warp_id,
                  sch_id, replay_buffer_idx, pc, sid, MEM_ON);
